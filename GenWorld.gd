...
const Debug_part = preload("res://Effects & Particles/debugParticles.tscn")
const Exit = preload("res://ExitDoor.tscn")
const Player = preload("res://Player/Player.tscn")
const Zombie = preload("res://Zombies/Zombie.tscn")
const ToxicBarrel = preload("res://World/ToxicBarrel.tscn")
const WoodBarrel = preload("res://World/WoodBarrel.tscn")
